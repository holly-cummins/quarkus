...
public interface QuarkusTestProfile {
     ...
     *
     * If this method is not overridden, then only the { QuarkusTestResourceLifecycleManager} classes enabled via the
     * { io.quarkus.test.common.WithTestResource} class
