...
public class QuarkusMainTestExtension extends AbstractJvmQuarkusTestExtension
    ...
    private int doJavaStart(ExtensionContext context, Class<? extends QuarkusTestProfile> profile, String[] arguments)
        ...
        try {
            ...
            Thread.currentThread()
                    .setContextClassLoader(startupAction.getClassLoader());
            Class<?> requiredTestClass = startupAction.getClassLoader().loadClass(context.getRequiredTestClass().getName());

            List<Object> additionalTestResources = getAdditionalTestResources(profileInstance, startupAction.getClassLoader());
            ...
            Map<String, String> properties = (Map<String, String>) testResourceManager.getClass()
                    .getMethod("start")
                    .invoke(testResourceManager);
            ...
            //                    profileInstance != null && profileInstance.disableGlobalTestResources(),
            //                    startupAction.getDevServicesProperties(), Optional.empty());
            //            System.out.println("UGH TRM IS " + testResourceManager.getClass()
            //                    .getClassLoader());
            //
            //            //            ((TestResourceManager) testResourceManager).init(profile != null ? profile.getName() : null);
            //            Map<String, String> properties = ((TestResourceManager) testResourceManager).start();
